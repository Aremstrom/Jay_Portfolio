    ...
    >
      <div className="flex w-full items-center space-x-20">
        <h1 className="text-heading-1 font-medium leading-[1.25em] text-secondary-400 md:leading-[1.08em]">
          I craft intelligent solutions from complex data, weaving ML magic and
          AI wizardry to unveil hidden patterns. My code turns numbers into
          narratives, empowering data-driven decisions that shape tomorrow's
          innovations.
        </h1>
      </div>
    </section>
